...
import { postMethodService } from "../component/service";
...
export default function CreateProject() {
    ...
    const handleChange = (name: string, value: string | number) => {
        setFormData((prev) => ({
            ...prev,
            [name]: name === "sprintDuration" || name === "estimatedHours" ? Number(value) : value
        }))
    }
  ...
  <div className="w-full max-w-6xl bg-white rounded-xl shadow-md p-8  ">
    ...
    <div className="flex justify-end gap-4 mt-10">
      ...
      <button
        ...
        className="px-4 py-2 rounded-md bg-blue-600 text-sm font-medium text-white hover:bg-blue-700 transition shadow"
      >
        Create
      </button>
    </div>
